...
public record SaleDTO(string Product, int Units, decimal Price, DateTime Date)
{
    public override string ToString() => $"{Product} ({Units}) {Price}€ - {Date.ToString("dd/MM/yyyy")}";
}
